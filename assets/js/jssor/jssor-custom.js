jQuery(document).ready(function ($) {
            ...
            var jssor_slider_diff = new $JssorSlider$("slider_diff_container", options_diff);

            var jssor_slider1 = new $JssorSlider$("slider1_container", options);
            var jssor_slider2 = new $JssorSlider$("slider2_container", options);
            var jssor_sliderb = new $JssorSlider$("sliderb_container", options_thumbnail);
            //responsive code begin
            //you can remove responsive code if you don't want the slider scales while window resizes
            function ScaleSlider() {
                var parentWidth = jssor_slider1.$Elmt.parentNode.clientWidth;
                var parentWidth2 = jssor_slider2.$Elmt.parentNode.clientWidth;
                var parentWidthb = jssor_sliderb.$Elmt.parentNode.clientWidth;
                var parentWidth_diff = jssor_slider_diff.$Elmt.parentNode.clientWidth;
                
                if (parentWidth_diff)
                    jssor_slider1.$ScaleWidth(Math.min(parentWidth_diff, 600));
                else
